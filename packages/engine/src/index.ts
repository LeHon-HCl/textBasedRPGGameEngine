...
// ---- content（§5.8 内容分级与过滤：单点谓词 / 占位回退 / 首启向导，22 号） ----
export { ContentFilter, contentWarningKey, resolveContentWizard } from './content/index.js';
export type {
...
// ---- persistence（§5.6 存档服务：适配器契约 / 内存实现 / 槽位元信息，20 号） -
export {
  AUTOSAVE_SLOTS,
  MemoryAdapter,
  projectSaveMeta,
